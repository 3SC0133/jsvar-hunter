...
```text
docs: improve README for public release
````
...
A sequência final será curta:

### `SECURITY.md`

Vamos deixar uma política objetiva para pesquisadores reportarem problemas no próprio projeto.
...
- TXT and JSONL output
```

### Finalmente

Fazemos uma última conferência:
...
Depois criamos a **Release `v2.0.0`**.

Não precisamos transformar isso em um projeto gigante. O objetivo agora é entregar uma ferramenta pequena, clara e útil.
